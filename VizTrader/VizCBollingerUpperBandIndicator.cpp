...
{
//-----------------------------------------------------------------------------
VizCBollingerUpperBandIndicator::VizCBollingerUpperBandIndicator() :  VizIIndicator(), TimePeriod(10), PriceField(viz::VEPF_DEFAULT), MovingAverageMethod(viz::VEMAM_SIMPLE), HorizontalShift(0), StandardDeviation(1.0)
{
	blockSignals(true);
	resetToDefaults();
	blockSignals(false);
...
//-----------------------------------------------------------------------------
VizCBollingerUpperBandIndicator::~VizCBollingerUpperBandIndicator()
{
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::resetToDefaults()
{
	QStringList names;
...
//-----------------------------------------------------------------------------
f64 VizCBollingerUpperBandIndicator::standardDeviation() const
{
	return StandardDeviation;
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::setStandardDeviation(f64 value)
{
...
//-----------------------------------------------------------------------------
s32 VizCBollingerUpperBandIndicator::timePeriod() const
{
	return TimePeriod;
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::setTimePeriod(s32 period)
{
...
//-----------------------------------------------------------------------------
VizEPriceField VizCBollingerUpperBandIndicator::priceField() const
{
	return PriceField;
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::setPriceField(VizEPriceField field)
{
	if(PriceField != field)
	{
...
//-----------------------------------------------------------------------------
VizEMovingAverageMethod VizCBollingerUpperBandIndicator::movingAverageMethod() const
{
	return MovingAverageMethod;
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::setMovingAverageMethod(VizEMovingAverageMethod method)
{
...
//-----------------------------------------------------------------------------
s32 VizCBollingerUpperBandIndicator::horizontalShift() const
{
	return HorizontalShift;
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::setHorizontalShift(s32 value)
{
...
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::build()
{
...
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::applyShiftProperties()
{
...
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::updateData()
{
	...
	Periods = TechnicalAnalysisFunctions->upperBollingerBand(Periods, TimePeriod, StandardDeviation, PriceField, MovingAverageMethod);

	QString name = tr("Bandas de Bollinger (upper)");
	QString t = QString("%1 (%2)").arg(name).arg(SecuritySymbol);
	vizObjectSetName(this, t);
	
}
//-----------------------------------------------------------------------------
QString VizCBollingerUpperBandIndicator::toolTip(const QPointF& p) const
{
...
//-----------------------------------------------------------------------------
int VizCBollingerUpperBandIndicator::propertyGetPriceField() const
{
	return static_cast<int>(priceField());
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::propertySetPriceField(int value)
{
	setPriceField(static_cast<VizEPriceField>(value));
}
//-----------------------------------------------------------------------------
int VizCBollingerUpperBandIndicator::propertyGetMovingAverageMethod() const
{
	return static_cast<int>(movingAverageMethod());
}
//-----------------------------------------------------------------------------
void VizCBollingerUpperBandIndicator::propertySetMovingAverageMethod(int value)
{
