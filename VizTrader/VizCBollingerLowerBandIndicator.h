...
//
//-----------------------------------------------------------------------------
#ifndef __VIZCBOLLINGERLOWERBANDINDICATOR_H__
#define __VIZCBOLLINGERLOWERBANDINDICATOR_H__
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
class VizCBollingerLowerBandIndicator : public VizIIndicator
{
	Q_OBJECT
...
public:
	VizCBollingerLowerBandIndicator();
	virtual ~VizCBollingerLowerBandIndicator();
