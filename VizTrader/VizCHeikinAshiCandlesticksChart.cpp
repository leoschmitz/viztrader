...
{
//-----------------------------------------------------------------------------
VizCHeikinAshiCandlesticksChart::VizCHeikinAshiCandlesticksChart() : VizIChart()
{
}
//-----------------------------------------------------------------------------
VizCHeikinAshiCandlesticksChart::~VizCHeikinAshiCandlesticksChart()
{
}
//-----------------------------------------------------------------------------
void VizCHeikinAshiCandlesticksChart::build()
{
...
//-----------------------------------------------------------------------------
void VizCHeikinAshiCandlesticksChart::paint(QPainter* painter)
{
	qreal pw = 0.0;
...
//-----------------------------------------------------------------------------
void VizCHeikinAshiCandlesticksChart::ajustToOverlayWithoutScale(f64 itemMinY, f64 itemMaxY)
{
...
//-----------------------------------------------------------------------------
bool VizCHeikinAshiCandlesticksChart::intersects(const QRectF& rect) const
{
	bool b = false;
...
//-----------------------------------------------------------------------------
bool VizCHeikinAshiCandlesticksChart::isLinear() const
{
	return true;
}
//-----------------------------------------------------------------------------
